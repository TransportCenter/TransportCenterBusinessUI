...
const docLinks = [
  {
    ...
    url: "https://transportcenter.net/about/start"
  },
  {
    translationId: "header.documentation",
    url: "https://transportcenter.net/about/business/docs"
  },
  {
    translationId: "header.sendSuggestion",
    url:
      "https://forms.office.com/Pages/ResponsePage.aspx?id=HmUDosgejEGdoSKDKZviaf0nDfM4IWpOsr5-G9X6SBpUQ0dSNDRYN0dEVjJSUDRMTUQwVERCMFBPVi4u"
  }
];
    ...
    return (
      <header className="app-header" role="banner">
        ...
        <div className="items-container">
          ...
          <div className="menu-container">
            <button
              className="item-icon profile menu-trigger"
            ...
            {this.state.openDropdown === profileDropdown && (
              <div className="menu">
                <button className="menu-item" onClick={this.logout}>
